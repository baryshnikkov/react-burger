...
const IngredientDetails = memo((props: IngredientDetailsProps) => {
	const { className, proteins, fat, carbohydrates, calories, image, name, isModal = true } = props;
	...
	return (
		<div className={cn(cls.IngredientDetails, { [cls.modal]: isModal, [cls.card]: !isModal }, [className])}>
			<p className={`${cls.title} text text_type_main-large`}>Детали ингредиента</p>
